...
import * as wjcSelfRef from 'wijmo/wijmo.viewer';
...
export declare class RequestEventArgs extends wjcCore.EventArgs {
    private _url;
    private _settings;
...
export declare class _TouchTrigger {
    ...
    touchMove: wjcSelfRef._TouchEvent;
    touchStart: wjcSelfRef._TouchEvent;
    touchEnd: wjcSelfRef._TouchEvent;
...
export declare class _PanEventArgs extends _TouchEventArgs {
    ...
    readonly type: wjcSelfRef._TouchEventType;
...
export declare class _PanTrigger extends _TouchTrigger {
    ...
    panMove: wjcSelfRef._PanEvent;
    panStart: wjcSelfRef._PanEvent;
    panEnd: wjcSelfRef._PanEvent;
...
export declare class ViewerBase extends wjcCore.Control implements IHttpRequestHandler {
    private _leftPanel;
    ...
    mouseModeChanged: wjcCore.Event;
    fullScreenChanged: wjcCore.Event;
    zoomFactorChanged: wjcCore.Event;
    queryLoadingData: wjcCore.Event;
    beforeSendRequest: wjcCore.Event;
    ...
    onMouseModeChanged(e?: wjcCore.EventArgs): void;
...
export declare class _MouseTool extends wjcCore.Control {
    ...
    readonly pageView: wjcSelfRef._IPageView;
...
export declare class ReportViewer extends ViewerBase {
    ...
    _createPage(index: number, defPageSize: _ISize): wjcSelfRef._Page;
    protected _actionElementClicked(element: SVGElement): void;
    protected _getActionInfo(element: SVGElement): _IDocAction;
}
