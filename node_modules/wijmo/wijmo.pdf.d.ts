...
import * as wjcSelfRef from 'wijmo/wijmo.pdf';
declare global  {
    interface Function {
        __super__: any;
        __proto__: any;
...
export declare class _SafeColor extends wjcCore.Color {
    constructor(color: string);
    _parse(c: string): boolean;
    static fromString(value: string): wjcCore.Color;
}
...
export declare class PdfFont {
    ...
    static _DEF_PDFKIT_FONT: wjcSelfRef.PdfFont;
    static _DEF_FONT: wjcSelfRef.PdfFont;
    private _family;
    private _size;
    private _style;
    private _weight;
...
export declare class _SvgAttr<T> {
    ...
    private _pCtx;
    private _nc;
    constructor(owner: _SvgElementBase, propName: string, propType: _SvgAttrType, defValue?: any, nc?: wjcSelfRef._SvgNumConversion, lCtx?: wjcSelfRef._SvgLengthContext, inheritable?: boolean);
...
export declare class _SvgNumAttr extends _SvgAttr<number> {
    constructor(owner: _SvgElementBase, propName: string, defValue?: any, nc?: wjcSelfRef._SvgNumConversion, pCtx?: wjcSelfRef._SvgLengthContext, inheritable?: boolean);
}
...
export declare class _SvgElementBase {
    ...
    constructor(ctx: _ISvgRenderContext, node: SVGElement, defRenderMode?: wjcSelfRef._SvgRenderMode);
...
export declare class _SvgTspanElementImpl extends _SvgClippableElementBase {
    ...
    _dx: _SvgNumAttr;
    _dy: _SvgNumAttr;
    _textDecoration: wjcSelfRef._SvgTextDecorationAttr;
