import * as wjcSelfRef from 'wijmo/wijmo';
...
export declare class Event {
    ...
    raise(sender: any, args?: wjcSelfRef.EventArgs): void;
    readonly hasHandlers: boolean;
    readonly handlerCount: number;
}
export declare class EventArgs {
    static empty: wjcSelfRef.EventArgs;
}
...
export declare class Control extends ControlBase {
    ...
    readonly gotFocus: wjcSelfRef.Event;
    onGotFocus(e?: EventArgs): void;
    readonly lostFocus: wjcSelfRef.Event;
    onLostFocus(e?: EventArgs): void;
    readonly refreshing: wjcSelfRef.Event;
    onRefreshing(e?: EventArgs): void;
    readonly refreshed: wjcSelfRef.Event;
...
export declare class NotifyCollectionChangedEventArgs extends EventArgs {
    static reset: wjcSelfRef.NotifyCollectionChangedEventArgs;
    action: NotifyCollectionChangedAction;
    item: any;
    index: number;
    constructor(action?: wjcSelfRef.NotifyCollectionChangedAction, item?: any, index?: number);
}
...
export declare class ObservableArray extends ArrayBase implements INotifyCollectionChanged {
    ...
    deferUpdate(fn: Function): void;
    implementsInterface(interfaceName: string): boolean;
    readonly collectionChanged: wjcSelfRef.Event;
    onCollectionChanged(e?: wjcSelfRef.NotifyCollectionChangedEventArgs): void;
...
export declare class CollectionView implements IEditableCollectionView, IPagedCollectionView {
    ...
    _idx: number;
    _filter: IPredicate;
    _srtDsc: wjcSelfRef.ObservableArray;
    _grpDesc: wjcSelfRef.ObservableArray;
    _newItem: any;
    _edtItem: any;
    _edtClone: any;
    _committing: boolean;
    ...
    _chgAdded: wjcSelfRef.ObservableArray;
    _chgRemoved: wjcSelfRef.ObservableArray;
    _chgEdited: wjcSelfRef.ObservableArray;
    _srtCvt: Function;
    _srtCmp: Function;
    _getError: Function;
    ...
    readonly collectionChanged: wjcSelfRef.Event;
    onCollectionChanged(e?: wjcSelfRef.NotifyCollectionChangedEventArgs): void;
    protected _raiseCollectionChanged(action?: wjcSelfRef.NotifyCollectionChangedAction, item?: any, index?: number): void;
    protected _notifyItemChanged(item: any): void;
    readonly sourceCollectionChanging: wjcSelfRef.Event;
    onSourceCollectionChanging(e: CancelEventArgs): boolean;
    readonly sourceCollectionChanged: wjcSelfRef.Event;
    ...
    readonly currentChanged: wjcSelfRef.Event;
    onCurrentChanged(e?: wjcSelfRef.EventArgs): void;
    readonly currentChanging: wjcSelfRef.Event;
    ...
    moveToNextPage(): boolean;
    moveToPage(index: number): boolean;
    readonly pageChanged: wjcSelfRef.Event;
    onPageChanged(e?: wjcSelfRef.EventArgs): void;
    readonly pageChanging: wjcSelfRef.Event;
    onPageChanging(e: PageChangingEventArgs): boolean;
    _getFullGroup(g: CollectionViewGroup): CollectionViewGroup;
    _getGroupByPath(groups: CollectionViewGroup[], level: number, path: string): wjcSelfRef.CollectionViewGroup;
    _getPageView(): any[];
...
export declare class Tooltip {
    ...
    showDelay: number;
    hideDelay: number;
    readonly popup: wjcSelfRef.Event;
...
export declare function showPopup(popup: HTMLElement, ref?: any, above?: boolean, fadeIn?: boolean, copyStyles?: any): any;
