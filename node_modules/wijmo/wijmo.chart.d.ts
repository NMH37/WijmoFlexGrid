...
import * as wjcSelfRef from 'wijmo/wijmo.chart';
...
export declare class FlexChartCore extends FlexChartBase {
    ...
    static _renderRotatedText(engine: IRenderEngine, text: string, pos: wjcCore.Point, halign: any, valign: any, center: wjcCore.Point, angle: number, className: string, groupClassName?: string, style?: any): any;
}
...
export declare class SeriesBase implements _ISeries {
    ...
    pointToData(pt: wjcCore.Point): wjcCore.Point;
    dataToPoint(pt: wjcCore.Point): wjcCore.Point;
    rendering: wjcCore.Event;
...
export declare class _FunnelSegment implements _IHitArea {
    ...
    private _offsetY;
    private _rotated;
    constructor(startPoint: wjcCore.Point, width: number, height: number, neckWidth: number, neckHeight: number, rotated?: boolean);
    contains(pt: wjcCore.Point): boolean;
    distance(pt: wjcCore.Point): number;
    readonly center: wjcCore.Point;
    tag: any;
