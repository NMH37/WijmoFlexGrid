...
import * as wjcSelfRef from 'wijmo/wijmo.nav';
export declare class TreeView extends wjcCore.Control {
    ...
    private _items;
    _selNode: TreeNode;
    _itmPath: wjcSelfRef._BindingArray;
    private _prevSel;
    private _dspPath;
    private _imgPath;
    private _dd;
...
export declare class TabPanel extends wjcCore.Control {
    private _tabs;
    ...
    readonly tabs: wjcCore.ObservableArray;
