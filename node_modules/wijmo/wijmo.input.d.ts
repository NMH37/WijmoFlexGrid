...
import * as wjcSelfRef from 'wijmo/wijmo.input';
...
export declare class ListBox extends wjcCore.Control {
    ...
    _createHeaderItem(group: wjcCore.CollectionViewGroup): string;
    private _click(e);
    private _keydown(e);
    private _keypress(e);
    _selectNext(): boolean;
...
export declare class Popup extends wjcCore.Control {
    ...
    protected _showTrigger: wjcSelfRef.PopupTrigger;
    protected _hideTrigger: wjcSelfRef.PopupTrigger;
