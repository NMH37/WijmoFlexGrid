...
import * as wjcSelfRef from 'wijmo/wijmo.olap';
...
export declare class _MdxQueryBuilder {
    ...
    buildQuery(): string;
    private buildWhereSection(measureShelf);
    private buildCubeName();
    private buildSubcubeExpression();
    private buildFilterAttributeSet(shelf, measures?);
    private buildFilterString(field, measures?);
    private getConditionFilterString(field, measures?);
    private getMeasureFilterExpressions(shelf);
    private getConditionFilterExpression(field, condition);
    private buildAxes();
    private buildSetForAttributesShelf(shelf);
    private buildSetForAttributesColumnShelf(shelf);
    private buildSetForMeasuresShelf(shelf);
    private buildAttributeSetForAxis(field);
    private buildMeasureSetForAxis(field);
}
...
export declare class _ListContextMenu extends wjcInput.Menu {
    ...
    _getTargetList(engine: PivotEngine, parm: string): wjcSelfRef.PivotFieldCollection;
}
...
export declare class PivotGrid extends wjcGrid.FlexGrid {
    ...
    onSortingColumn(e: wjcGrid.CellRangeEventArgs): boolean;
    onDraggingColumn(e: wjcGrid.CellRangeEventArgs): boolean;
    onDraggedColumn(e: wjcGrid.CellRangeEventArgs): void;
    _updatedView(): void;
...
export declare class DetailDialog extends wjcInput.Popup {
    private _g;
    private _sCnt;
    private _dSummary;
    private _dGrid;
...
export declare class PivotChart extends wjcCore.Control {
    ...
    footerStyle: any;
    refresh(fullUpdate?: boolean): void;
    saveImageToDataUrl(format: wjcChart.ImageFormat, done: Function): void;
...
export declare class Slicer extends wjcCore.Control {
    ...
    _fld: PivotField;
    _edt: wjcGridFilter.ValueFilterEditor;
    ...
    multiSelect: boolean;
    refresh(fullUpdate?: boolean): void;
    _fldPropChange(s: PivotField, e: wjcCore.PropertyChangedEventArgs): void;
    _updateHeader(): void;
    _clear(): void;
}
